...
def build_model(architecture: str = "e2") -> FasterRCNN:
    if architecture == "e2":
...
def load_model(checkpoint_path: str | Path, device: torch.device) -> FasterRCNN:
    ...
    try:
        # Le checkpoint provient du notebook de l'utilisateur et peut contenir
        # des métadonnées Python en plus des tenseurs.
